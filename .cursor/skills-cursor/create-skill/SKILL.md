...
2. **Target location**: Should this be a personal skill (~/.cursor/skills/) or shared repo skill (.agents/skills/)?
...
- "Where should this skill be stored?" with options like ["Personal (~/.cursor/skills/)", "Shared repo (.agents/skills/)"]
