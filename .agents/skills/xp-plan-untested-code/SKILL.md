---
name: xp-plan-untested-code
description: Plan tests for untested code with coverage gaps and risk-based prioritization. Use when the user asks for a test plan for untested code or coverage gaps.
---
